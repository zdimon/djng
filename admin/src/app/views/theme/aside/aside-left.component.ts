...
// Layout
import { LayoutConfigService, MenuAsideService, IMenuOptions, IOffcanvasOptions } from '../../../core/_base/layout';
...
export class AsideLeftComponent implements OnInit, AfterViewInit {
    ...
    menuCanvasOptions: IOffcanvasOptions = {
        baseClass: 'kt-aside',
        overlay: true,
    ...
    ngOnInit(): void {
        ...
        this.menuAsideService.getUserMenu().subscribe(list => {
            this.menu = list;
            this.cdr.markForCheck();
        });
        ...
        //             getMenu('admin').forEach(element => {
        //                 if (this.menu.indexOf(element) === -1) {
        ...
        //             getMenu('moderator').forEach(element => {
        //                 if (this.menu.indexOf(element) === -1) {
        //                     this.menu.push(element);
        //                 }
        //             });
        ...
        //             getMenu('director').forEach(element => {
        //                 if (this.menu.indexOf(element) === -1) {
        //                     this.menu.push(element);
        //                 }
        //             });
        ...
        //             getMenu('manager').forEach(element => {
        //                 if (this.menu.indexOf(element) === -1) {
        //                     this.menu.push(element);
        //                 }
        //             });
        //         }
        //         if (user.roles.indexOf('webmaster') > -1) {
        //             getMenu('webmaster').forEach(element => {
        //                 if (this.menu.indexOf(element) === -1) {
        //                     this.menu.push(element);
        //                 }
        //             });
