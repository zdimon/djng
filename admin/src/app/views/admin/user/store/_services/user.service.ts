...
const API_LIST_URL = environment.apiUrl + '/user/list';
const API_UPDATE_URL = environment.apiUrl + '/user/list';
const API_CREATE_URL = environment.apiUrl + '/user/list';
const API_DELETE_URL = environment.apiUrl + '/user/list';
