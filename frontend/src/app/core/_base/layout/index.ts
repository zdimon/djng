// Directives
export { ISparklineChartOptions, SparklineChartDirective } from './directives/sparkline-chart.directive';
...
export { IOffcanvasOptions } from './directives/offcanvas.directive';
export { IScrollTopOptions } from './directives/scroll-top.directive';
export { ToggleOptions } from './directives/toggle.directive';

export { IIresults } from './models/menu-aside.model';
export { LayoutConfigModel } from './models/layout-config.model';
export { IMenuOptions } from './directives/menu.directive';
...
// Shared
export { DateProvider } from './shared/provider/date-provider';
